...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      'bottom-cap',
      '../../assets/img/bar/barVertical_blue_bottom.png'
    );
    ...
    this.load.image(
      'bottom-cap-shadow',
      '../../assets/img/bar/barVertical_shadow_bottom.png'
    );
    this.load.image(
      'middle-shadow',
      '../../assets/img/bar/barVertical_shadow_mid.png'
    );
    this.load.image(
      'top-cap-shadow',
      '../../assets/img/bar/barVertical_shadow_top.png'
    );

    this.load.multiatlas({
      key: 'lifter',
      atlasURL: '../../assets/lifter.json',
      baseURL: '',
      path: '../../assets/',
    });
